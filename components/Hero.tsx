        ...
        <div className="flex flex-col items-center space-y-8 md:space-y-12">
          ...
          >
            ...
            <div className="relative px-4">
              <h1 className="text-4xl md:text-5xl lg:text-7xl font-semibold leading-[1.1] tracking-wide relative">
                <motion.span
                  className="block mb-2 md:mb-3 text-white drop-shadow-2xl"
            ...
            >
              ...
              <Link
                href={'/wycena'}
                className="w-full sm:w-auto group relative px-6 md:px-8 py-3 md:py-4 bg-white/10 text-white border-2 border-white/30 rounded-full font-semibold text-sm md:text-lg hover:bg-white/20 transition-all duration-300 hover:scale-105 flex items-center justify-center space-x-2"
              >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
                {deliverySteps.map((step, index) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`relative w-12 h-12 md:w-16 md:h-16 rounded-xl md:rounded-2xl flex items-center justify-center mb-2 md:mb-3 transition-all duration-300 ${
                          isActive
                      ...
                      >
                        ...
                        <step.icon
                          className={`relative z-10 w-6 h-6 md:w-8 md:h-8 text-white transition-transform duration-300 ${isActive ? 'scale-110' : 'scale-100'}`}
                        />
                      </div>
